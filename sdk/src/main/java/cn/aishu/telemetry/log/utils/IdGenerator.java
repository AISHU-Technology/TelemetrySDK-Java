package cn.aishu.telemetry.log.utils;
...
/**
 * Interface used by the {@link //SdkTracer} to generate new {@link SpanId}s and
 * {@link TraceId}s.
 */
@ThreadSafe
public interface IdGenerator {
    ...
    /**
     * Returns a {@link IdGenerator} that generates purely random IDs, which is the
     * default for
     * OpenTelemetry.
     *
     * <p>
     * The underlying implementation uses
     * {@link java.util.concurrent.ThreadLocalRandom} for
